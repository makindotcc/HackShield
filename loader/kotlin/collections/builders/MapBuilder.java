...
KMutableMap {
    ...
    public void clear() {
        ...
        if (n <= n2) {
            ...
            do {
                int hash;
                if ((hash = this.presenceArray[++i]) < 0) continue;
    ...
    private final void ensureCapacity(int capacity) {
        if (capacity > this.getCapacity()) {
            ...
            boolean bl = false;
            int[] arrn2 = Arrays.copyOf(arrn, newSize);
    ...
    public static final /* synthetic */ void access$setPresenceArray$p(MapBuilder $this, int[] arrn) {
        $this.presenceArray = arrn;
    }

    public static final /* synthetic */ void access$setKeysArray$p(MapBuilder $this, Object[] arrobject) {
        $this.keysArray = arrobject;
    }

    public static final /* synthetic */ void access$setValuesArray$p(MapBuilder $this, Object[] arrobject) {
        $this.valuesArray = arrobject;
    }
    ...
    KMutableIterator {
        ...
        public V next() {
            ...
            Object result = arrobject[this.getLastIndex$kotlin_stdlib()];
            this.initNext$kotlin_stdlib();
            return (V)result;
        }
    ...
    KMutableIterator {
        ...
        public final void nextAppendString(@NotNull StringBuilder sb) {
            ...
            Object[] arrobject = this.getMap$kotlin_stdlib().valuesArray;
            Intrinsics.checkNotNull(arrobject);
            Object value = arrobject[this.getLastIndex$kotlin_stdlib()];
