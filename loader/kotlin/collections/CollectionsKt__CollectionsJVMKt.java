...
class CollectionsKt__CollectionsJVMKt {
    ...
    private static final <T> T[] copyToArrayImpl(Collection<?> collection, T[] array) {
        ...
        Object[] arrobject = CollectionToArray.toArray(collection, array);
        if (arrobject == null) {
    ...
    public static final <T> Object[] copyToArrayOfAny(@NotNull T[] $this$copyToArrayOfAny, boolean isVarargs) {
        ...
        Object[] arrobject = isVarargs && Intrinsics.areEqual($this$copyToArrayOfAny.getClass(), Object[].class) ? $this$copyToArrayOfAny : Arrays.copyOf($this$copyToArrayOfAny, $this$copyToArrayOfAny.length, Object[].class);
        Intrinsics.checkNotNullExpressionValue(arrobject, "if (isVarargs && this.ja\u2026 Array<Any?>::class.java)");
        return arrobject;
    }
