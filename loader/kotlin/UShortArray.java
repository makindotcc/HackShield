...
KMappedMarker {
    ...
    public static final short get-Mh2AYeg(short[] $this, int index) {
        short s = $this[index];
        boolean bl = false;
    ...
    public static boolean contains-xj2QHRw(short[] $this, short element) {
        short s = element;
        boolean bl = false;
        return ArraysKt.contains($this, s);
    }
    ...
    public static boolean containsAll-impl(short[] $this, @NotNull Collection<UShort> elements) {
        ...
        do {
            ...
            boolean bl3 = false;
            if (!ArraysKt.contains($this, s)) return false;
            bl = true;
        } while (bl);
        return false;
    }
    ...
    public static boolean equals-impl(short[] arrs, @Nullable Object object) {
        short[] arrs2;
