...
extends RangesKt__RangesKt {
    ...
    public static final Short toShortExactOrNull(int $this$toShortExactOrNull) {
        ...
        return -32768 <= n && 32767 >= n ? Short.valueOf((short)$this$toShortExactOrNull) : null;
    }

    @Nullable
    public static final Short toShortExactOrNull(long $this$toShortExactOrNull) {
        long l = $this$toShortExactOrNull;
        return (long)-32768 <= l && (long)32767 >= l ? Short.valueOf((short)$this$toShortExactOrNull) : null;
    }
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(@NotNull T $this$coerceIn, @NotNull ClosedFloatingPointRange<T> range) {
        ...
        return range.lessThanOrEquals($this$coerceIn, (T)range.getStart()) && !range.lessThanOrEquals((T)range.getStart(), $this$coerceIn) ? range.getStart() : (range.lessThanOrEquals((T)range.getEndInclusive(), $this$coerceIn) && !range.lessThanOrEquals($this$coerceIn, (T)range.getEndInclusive()) ? range.getEndInclusive() : $this$coerceIn);
    }
