...
CoroutineStackFrame {
    ...
    public void resumeWith(@NotNull Object result) {
...

        {
            block1: {
                cur = this.result;
                if (cur != CoroutineSingletons.UNDECIDED) break block1;
                if (!SafeContinuation.RESULT.compareAndSet(this, (Object)CoroutineSingletons.UNDECIDED, result)) ** GOTO lbl-1000
                return;
            }
            if (cur != IntrinsicsKt.getCOROUTINE_SUSPENDED()) throw (Throwable)new IllegalStateException("Already resumed");
