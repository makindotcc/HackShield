...
implements KType {
    ...
    private final String getArrayClassName(Class<?> $this$arrayClassName) {
        Class<?> class_ = $this$arrayClassName;
        return Intrinsics.areEqual(class_, boolean[].class) ? "kotlin.BooleanArray" : (Intrinsics.areEqual(class_, char[].class) ? "kotlin.CharArray" : (Intrinsics.areEqual(class_, byte[].class) ? "kotlin.ByteArray" : (Intrinsics.areEqual(class_, short[].class) ? "kotlin.ShortArray" : (Intrinsics.areEqual(class_, int[].class) ? "kotlin.IntArray" : (Intrinsics.areEqual(class_, float[].class) ? "kotlin.FloatArray" : (Intrinsics.areEqual(class_, long[].class) ? "kotlin.LongArray" : (Intrinsics.areEqual(class_, double[].class) ? "kotlin.DoubleArray" : "kotlin.Array")))))));
    }
