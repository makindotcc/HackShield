...
implements Examinable {
    ...
    extends AbstractSet<TextDecoration> {
        ...
        public Object @NotNull [] toArray() {
            return (Object[])DECORATIONS.clone();
        }
    ...
    extends AbstractCollection<TextDecoration.State> {
        ...
        public Iterator<TextDecoration.State> iterator() {
            return Spliterators.iterator(Arrays.spliterator(this.toArray((T[])EMPTY_STATE_ARRAY)));
        }
        ...
        @Override
        public Object @NotNull [] toArray() {
            TextDecoration.State[] states = new TextDecoration.State[MAP_SIZE];
