...
import net.kyori.adventure.text.format.AlwaysMerger;
import net.kyori.adventure.text.format.DecorationMap;
import net.kyori.adventure.text.format.IfAbsentOnTargetMerger;
...
implements Style {
    ...
    implements Style.Builder {
        ...
        Style.Builder decorationIfAbsent(@NotNull TextDecoration decoration, @NotNull TextDecoration.State state) {
            Objects.requireNonNull(state, "state");
            @Nullable TextDecoration.State thisState = this.decorations.get(decoration);
