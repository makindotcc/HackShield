...
import pl.hackshield.shaded.org.yaml.snakeyaml.parser.ParserException;
import pl.hackshield.shaded.org.yaml.snakeyaml.parser.Production;
import pl.hackshield.shaded.org.yaml.snakeyaml.parser.VersionTagsTuple;
...
import pl.hackshield.shaded.org.yaml.snakeyaml.scanner.ScannerImpl;
...
implements Parser {
    ...
    private Event parseNode(boolean block, boolean indentlessSequence) {
        ...
        if (this.scanner.checkToken(Token.ID.Scalar)) {
            ...
            ScalarEvent scalarEvent = new ScalarEvent(anchor, tag, implicitValues, token.getValue(), startMark, endMark, token.getStyle());
            this.state = this.states.pop();
            return var3_17;
        }
        ...
        if (anchor != null || tag != null) {
            ScalarEvent scalarEvent = new ScalarEvent(anchor, tag, new ImplicitTuple(implicit, false), "", startMark, endMark, DumperOptions.ScalarStyle.PLAIN);
            this.state = this.states.pop();
            return var3_17;
        }
