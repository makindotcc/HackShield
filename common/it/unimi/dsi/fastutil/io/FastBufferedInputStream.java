...
implements RepositionableStream {
    ...
    extends Enum<LineTerminator> {
        public static final /* enum */ LineTerminator CR = new LineTerminator();
        public static final /* enum */ LineTerminator LF = new LineTerminator();
        public static final /* enum */ LineTerminator CR_LF = new LineTerminator();
        private static final /* synthetic */ LineTerminator[] $VALUES;

        public static LineTerminator[] values() {
            return (LineTerminator[])$VALUES.clone();
        }

        public static LineTerminator valueOf(String name) {
            return Enum.valueOf(LineTerminator.class, name);
        }

        private static /* synthetic */ LineTerminator[] $values() {
            return new LineTerminator[]{CR, LF, CR_LF};
        }

        static {
            $VALUES = LineTerminator.$values();
        }
    }
}
