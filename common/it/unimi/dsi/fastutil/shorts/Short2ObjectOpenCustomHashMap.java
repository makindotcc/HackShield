...
Hash {
    ...
    private abstract class MapSpliterator<ConsumerType, SplitType extends MapSpliterator<ConsumerType, SplitType>> {
        ...
        public long estimateSize() {
            if (!this.hasSplit) {
                return Short2ObjectOpenCustomHashMap.this.size - this.c;
            }
            return Math.min((long)(Short2ObjectOpenCustomHashMap.this.size - this.c), (long)((double)Short2ObjectOpenCustomHashMap.this.realSize() / (double)Short2ObjectOpenCustomHashMap.this.n * (double)(this.max - this.pos)) + (long)(this.mustReturnNull ? 1 : 0));
        }
